#include "network_sispop_sispopnet_SispopnetDaemon.h"
...
extern "C"
{
  ...
  Java_network_sispop_sispopnet_SispopnetDaemon_Obtain(JNIEnv *env, jclass)
  {
  ...
  Java_network_sispop_sispopnet_SispopnetDaemon_Free(JNIEnv *env, jclass, jobject buf)
  {
  ...
  Java_network_sispop_sispopnet_SispopnetDaemon_Configure(JNIEnv *env, jobject self,
                                                    jobject conf)
  {
  ...
  Java_network_sispop_sispopnet_SispopnetDaemon_Mainloop(JNIEnv *env, jobject self)
  {
  ...
  JNIEXPORT jboolean JNICALL
  Java_network_sispop_sispopnet_SispopnetDaemon_IsRunning(JNIEnv *env, jobject self)
  {
    llarp_main *ptr = GetImpl< llarp_main >(env, self);
  ...
  JNIEXPORT jboolean JNICALL
  Java_network_sispop_sispopnet_SispopnetDaemon_Stop(JNIEnv *env, jobject self)
  {
    llarp_main *ptr = GetImpl< llarp_main >(env, self);
    if(ptr == nullptr)
      return JNI_FALSE;
  ...
  JNIEXPORT jboolean JNICALL
  Java_network_sispop_sispopnet_SispopnetDaemon_InjectVPN(JNIEnv *env, jobject self,
                                                    jobject vpn)
  {
    llarp_main *ptr         = GetImpl< llarp_main >(env, self);
    sispopnet_jni_vpnio *impl = GetImpl< sispopnet_jni_vpnio >(env, vpn);
