#include "network_sispop_sispopnet_SispopnetConfig.h"
#include <llarp.hpp>
...
extern "C"
{
  ...
  Java_network_sispop_sispopnet_SispopnetConfig_Obtain(JNIEnv* env, jclass)
  {
  ...
  Java_network_sispop_sispopnet_SispopnetConfig_Free(JNIEnv* env, jclass, jobject buf)
  {
    llarp_config_free(FromBuffer< llarp_config >(env, buf));
  }

  JNIEXPORT jboolean JNICALL
  Java_network_sispop_sispopnet_SispopnetConfig_Load(JNIEnv* env, jobject self,
                                               jstring fname)
  {
